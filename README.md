...
The goal was to determine the lowest-cost warehouse allocation for customer orders while considering operational constraints such as product availability, VMI rules, warehouse-port connections, transportation rates and warehouse capacity.
